...
const CarDetails = ({isOpen,handleModal,car}:CarDetailsProps) => {
                                ...
                                <div className='flex gap-3'> 
                                    {/* map */}
                                    {
                                        angles.map((item, index) => (
                                            <div key={`${item} ${index}`} className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                                            <Image src={fetchCarImage(car,item)} alt='car model' fill priority className='object-contain' />
                                        </div> 
                                        ))
                                    }
                                </div>
